 ...
 * 
 */
@WebServiceClient(name = "ServicioWeb", targetNamespace = "http://ServicioWebException/", wsdlLocation = "http://localhost:8080/Practica1WebSOAP/ServicioWeb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIOWEB_QNAME = new QName("http://ServicioWebException/", "ServicioWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Practica1WebSOAP/ServicioWeb?wsdl");
    ...
    public ServicioWeb getServicioWebPort() {
        return super.getPort(new QName("http://ServicioWebException/", "ServicioWebPort"), ServicioWeb.class);
    }
    ...
    public ServicioWeb getServicioWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ServicioWebException/", "ServicioWebPort"), ServicioWeb.class, features);
    }
